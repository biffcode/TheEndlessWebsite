          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-black/30 backdrop-blur-sm rounded-lg p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <a href="https://discord.gg/hkVd8rwC" target="_blank" rel="noopener noreferrer" className={`${currentSettings.socialIcon} rounded-lg p-4 flex flex-col items-center border ${currentSettings.socialIconBorder} transition-all hover:transform hover:scale-105`}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mb-2 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://www.youtube.com/@EndlessNovel" target="_blank" rel="noopener noreferrer" className={`${currentSettings.socialIcon} rounded-lg p-4 flex flex-col items-center border ${currentSettings.socialIconBorder} transition-all hover:transform hover:scale-105`}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mb-2 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="bg-black/30 backdrop-blur-sm rounded-lg p-6">
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                {/* IGDB Icon */}
                <div className="w-12 h-12 rounded-full bg-[#FF6B6B] flex items-center justify-center text-white font-bold text-sm">
                  IGDB
                </div>
                ...
                <div className="flex items-center justify-center rounded-full bg-black/30 w-12 h-12 text-white text-sm">
                  +2.5k
                </div>
              </div>

              <a 
                href="https://discord.gg/hkVd8rwC" 
                target="_blank" 
