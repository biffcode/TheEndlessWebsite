          ...
          if (storyRef) {
            ...
            if (fullStory) {
              setStory({
                ...
                coverImage: fullStory.coverImage || fullStory.coverImg || (storyRef.coverImage || storyRef.coverImg)
              });
            } else {
              ...
              setStory({
                ...
                coverImage: storyRef.coverImage || storyRef.coverImg || genreImages[storyRef.genre?.toLowerCase()] || genreImages.default
              });
            }
            ...
            <nav className={`flex bg-black/30 px-4 py-2 rounded-lg ${currentSettings.navigationFont}`}>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  >
                    {/* Profile picture */}
                    <div className="h-6 w-6 rounded-full overflow-hidden border-2 border-white/30 flex-shrink-0">
                      {user?.profileImage ? (
                        <Image 
                ...
                <Link 
                  href="/auth" 
                  className={`${currentSettings.buttonColor} text-white px-4 py-1 rounded-md text-sm transition-all hover:scale-105 flex items-center gap-1 ml-2`}
                >
            ...
            <div className={`${currentSettings.cardBg || "bg-black/30"} backdrop-blur-sm rounded-lg p-6 border border-white/10 mb-8`}>
              ...
              <div className="mb-8">
                ...
                <div className="w-full h-64 md:h-80 relative rounded-lg overflow-hidden mb-6">
                  <Image 
                    src={story.coverImage || story.coverImg || "/images/community/community2.jpg"}
                    alt={story.title}
                    fill
