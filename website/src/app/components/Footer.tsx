      ...
      <div className="container mx-auto px-4">
          ...
          <div className={`grid grid-cols-2 md:grid-cols-3 gap-x-12 gap-y-4 ${currentSettings.navigationFont}`}>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/community" className={`text-gray-400 hover:${currentSettings.menuTextColor.replace('text-', 'text-')} text-xs transition`}>
                    Community
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/privacy" className={`text-gray-400 hover:${currentSettings.menuTextColor.replace('text-', 'text-')} text-xs transition`}>
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link href="/terms" className={`text-gray-400 hover:${currentSettings.menuTextColor.replace('text-', 'text-')} text-xs transition`}>
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className={`text-gray-400 hover:${currentSettings.menuTextColor.replace('text-', 'text-')} text-xs transition`}>
                    Contact Us
                  </Link>
                </li>
              </ul>
        ...
        <div className="pt-6 border-t border-gray-800 text-center">
          ...
          <div className="flex justify-center space-x-4 mt-4">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300 transition">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
              </svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300 transition">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300 transition">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
